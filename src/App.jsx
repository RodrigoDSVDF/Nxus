...
const faqItems = [
  { 
    ...
    a: "Não. É um sistema operacional para performance cognitiva. A IA é tratada no Módulo 4 como uma ferramenta poderosa que você aprenderá a dominar porque primeiro dominou os princípios de foco, aprendizado e gestão de carga." 
  },
  { 
    q: "Sou iniciante em produtividade. Serve para mim?", 
    a: "Perfeitamente. O Nexus foi projetado como um framework a ser construído do zero. Você começa com os pilares fundamentais e avança progressivamente. É o melhor momento para começar, com a fundação correta." 
  },
  { 
    q: "O material não fica desatualizado com novas ferramentas de IA?", 
    a: "Não. Focamos em princípios e arquiteturas mentais. O Módulo de IA te ensina Engenharia de Contexto e Prompting Sistêmico – habilidades independentes de ferramenta que você aplicará a qualquer modelo, hoje ou daqui a 5 anos." 
  },
  { 
    q: "Em quanto tempo verei resultados práticos?", 
    a: "Primeiros resultados em clareza e redução de estresse nas primeiras 72h. Resultados expressivos em produtividade e qualidade de output dentro da primeira semana de implementação consistente do blueprint." 
  },
];
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] font-['Poppins',sans-serif] overflow-x-hidden text-slate-100 selection:bg-[#FF4F1F] selection:text-white">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        {/* Gradientes */}
        <div className="absolute top-[-20%] left-[-10%] w-[800px] h-[800px] bg-[#2DD4BF]/5 rounded-full blur-[120px] animate-pulse"></div>
        <div className="absolute bottom-[-20%] right-[-10%] w-[600px] h-[600px] bg-[#FF6B35]/5 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      <section id="hero" ref={heroRef} className="relative z-10 pt-20 pb-32 px-4 overflow-hidden">
        <div className={`max-w-7xl mx-auto text-center transition-all duration-1000 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold leading-tight mb-8 tracking-tight">
            <span className="neon-text">NEXUS MANUAL</span>
          </h1>
          ...
          <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto mb-12 leading-relaxed">
            Um framework neuroestratégico para profissionais que desejam dominar a atenção,{" "}
            <span className="text-[#2DD4BF] font-semibold">
              acelerar decisões e transformar ferramentas de IA em extensões da sua inteligência.
            </span>
          </p>
          ...
          <div className="flex flex-col items-center gap-6">
            <a
              ...
              onClick={handleTrackCheckout}
            >
              <Button className="pulse-button relative w-full md:w-auto h-auto py-3 md:py-4 px-8 md:px-12 text-white font-bold text-sm md:text-xl rounded-xl flex items-center justify-center gap-3">
        ...
        <div className={`max-w-6xl mx-auto transition-all duration-1000 ${videoVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-8">
              Assista esta demonstração exclusiva de{" "}
              <span className="text-[#2DD4BF] font-semibold">2 minutos</span>{" "}
              e entenda como o Nexus transforma produtividade em resultados mensuráveis.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
            {[
              { value: "15min", label: "Setup Completo" },
              { value: "72h", label: "Primeiros Resultados" },
              { value: "10x", label: "Produtividade" },
              { value: "100%", label: "Satisfação Garantida" }
            ].map((stat, index) => (
              <div key={index} className="text-center p-6 bg-[#111]/50 rounded-xl border border-gray-800 hover:border-[#2DD4BF]/30 transition-colors group">
                <div className="text-3xl font-bold text-[#2DD4BF] mb-2 group-hover:scale-110 transition-transform">
                  {stat.value}
                </div>
          ...
          <div className="text-center mt-12">
            ...
            >
              <Button className="bg-gradient-to-r from-[#FF6B35] to-[#FF4F1F] hover:from-[#FF4F1F] hover:to-[#FF6B35] text-white font-bold py-3 md:py-4 px-4 md:px-10 rounded-xl text-sm md:text-lg transition-all hover:scale-105 shadow-2xl shadow-[#FF6B35]/30 w-full md:w-auto">
      ...
      <div className="relative z-10 border-y border-[#333] bg-[#0A0A0A]/80 backdrop-blur-md py-8">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            {["TECH<span class='text-[#2DD4BF]'>CORP</span>", "InnovateLabs", "Future<span class='text-[#FF6B35]'>/</span>Work", "Global<span class='text-[#2DD4BF]'>Systems</span>"]
              .map((company, index) => (
                <div key={index} className="text-2xl font-bold text-white" dangerouslySetInnerHTML={{ __html: company }} />
              ))}
          </div>
        </div>
      </div>
                ...
                {[
                  {
                    ...
                    text: "Gastar horas em tarefas operacionais que poderiam ser automatizadas, deixando você exausto para o que realmente importa."
                  },
                  {
                    icon: Brain,
                    title: "Aprendizado Fragmentado:",
                    text: "Pular de ferramenta em ferramenta sem um framework sólido, acumulando 'peças soltas' de conhecimento que não se integram."
                  }
                ].map((item, index) => (
                  <li key={index} className="flex items-start p-4 bg-[#111]/50 border border-[#FF6B35]/20 rounded-xl hover:border-[#FF6B35]/50 transition-colors group">
                    <item.icon className="w-6 h-6 text-[#FF6B35] mr-4 flex-shrink-0 mt-1 group-hover:scale-110 transition-transform" />
                    <span>
                      <strong className="text-white group-hover:text-[#FF6B35] transition-colors">{item.title}</strong> {item.text}
                    </span>
                  </li>
                ))}
              </ul>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Não é apenas um curso. É o seu novo ecossistema de produtividade. O Nexus resolve o maior problema da atualidade: o excesso de informação sem um sistema para processá-la.
            </p>
          </div>
            ...
            {bentoFeatures.map((item, index) => (
              ...
              >
                ...
                <div className="relative z-10 p-8 h-full flex flex-col justify-end">
                  ...
                  <h3 className={`text-2xl font-bold mb-3 transition-colors ${activeFeature?.title === item.title ? 'text-[#FF4F1F]' : 'text-white group-hover:text-[#2DD4BF]'}`}>
                    {item.title}
                  </h3>
        ...
        <div className="horizontal-banner-wrapper">
          <div className="horizontal-banner">
            <div className="banner-content" style={{ animationDuration: '10s' }}>
              {[
                { icon: Brain, text: "BIOHACKING DO FOCO" },
                { icon: Target, text: "METODOLOGIAS ATIVAS" },
                { icon: Cpu, text: "DEEP WORK" },
                { icon: Layers, text: "INTELIGÊNCIA ESTRATÉGICA" }
              ].flatMap((item) => Array(2).fill(item)).map((item, index) => (
                <span key={index} className="banner-item font-mono tracking-widest flex items-center text-lg text-white">
                  <item.icon className="w-5 h-5 mr-3 text-[#FF6B35]" /> {item.text}
                </span>
              ))}
            </div>
          </div>
      ...
      <section id="stack" ref={stackRef} className="relative z-10 py-32 px-4">
        <div className="max-w-5xl mx-auto bg-[#1A2A3A]/80 backdrop-blur-xl border border-[#333] rounded-[2.5rem] p-8 md:p-16 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#2DD4BF]/10 rounded-full blur-[100px]"></div>
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#FF6B35]/10 rounded-full blur-[100px]"></div>
          ...
          <div className={`relative z-10 transition-all duration-1000 ${stackVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
            ...
            <div className="mb-8 text-center">
              <div className="inline-block px-6 py-3 bg-gradient-to-r from-[#2DD4BF]/20 to-[#FF6B35]/20 rounded-xl group hover:scale-105 transition-transform duration-300">
            ...
            <div className="mt-16 text-center">
              <p className="text-xl text-gray-400 mb-6">
                Valor Justo do Stack: <span className="line-through">R$ 641,00</span>
              </p>
              <p className="text-3xl md:text-5xl font-extrabold text-white mb-8">
                Hoje por apenas: <span className="text-[#2DD4BF]">R$ 47</span>
              ...
              <a
                ...
                onClick={handleTrackCheckout}
              >
                <Button className="pulse-button w-full h-auto py-3 md:h-16 text-white font-bold text-sm md:text-xl rounded-xl flex items-center justify-center gap-2 md:gap-3">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {faqItems.map((item, index) => (
              <div 
                key={index} 
                className="bg-[#111]/50 border border-[#333] rounded-2xl overflow-hidden hover:border-[#2DD4BF]/50 transition-colors"
              >
                <button
                  className="flex justify-between items-center w-full p-6 text-left cursor-pointer list-none"
                  onClick={() => toggleFAQ(index)}
                >
                  <h3 className="text-lg font-bold text-white">{item.q}</h3>
                  <ChevronRight className={`w-5 h-5 text-[#2DD4BF] transform transition-transform ${openFAQIndex === index ? 'rotate-90' : ''}`} />
                </button>
                {openFAQIndex === index && (
      ...
      <section id="offer" ref={offerRef} className="relative z-10 py-32 px-4 overflow-hidden">
        ...
        <div className={`max-w-4xl mx-auto text-center relative z-20 transition-all duration-1000 ${offerVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          <div className="mb-12">
            <Shield className="w-20 h-20 text-[#2DD4BF] mx-auto mb-6 animate-pulse" />
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8 leading-relaxed">
              Acesse todo o sistema Nexus, estude os protocolos, implemente o blueprint e use os prompts. Se em 7 dias você não sentir uma{" "}
              <span className="text-[#2DD4BF]">clareza mental tangível</span>, um aumento na sua produtividade profunda e uma sensação de controle sobre o fluxo de informação, devolvemos 100% do seu investimento.
            </p>
          ...
          <div className="bg-[#1A2A3A] border-2 border-[#FF4F1F] rounded-[3rem] p-12 shadow-2xl shadow-[#FF4F1F]/20 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="text-[#FF6B35] font-medium mb-8 uppercase tracking-wider">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-12">
                <img 
                  src={produtoImg} 
                  alt="Pack Nexus" 
                  className="w-64 rounded-xl shadow-2xl border border-[#333] rotate-[-5deg] group-hover:rotate-0 transition-all duration-500" 
                />
                <div className="text-left">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center text-sm text-gray-300">
                      <Check className="w-4 h-4 text-[#2DD4BF] mr-2" /> Acesso Imediato via E-mail
                    </div>
                    <div className="flex items-center text-sm text-gray-300">
                      <Check className="w-4 h-4 text-[#2DD4BF] mr-2" /> Plataforma Segura e Confiável
                    </div>
                    <div className="flex items-center text-sm text-gray-300">
                      <Check className="w-4 h-4 text-[#2DD4BF] mr-2" /> Atualizações Vitalícias Inclusas
                    </div>
                  </div>
                </div>
              </div>
              ...
              <a
                ...
                onClick={handleTrackCheckout}
              >
                <Button className="pulse-button w-full h-auto py-4 md:h-20 text-white font-extrabold text-sm md:text-2xl rounded-2xl flex items-center justify-center gap-2 md:gap-4 hover:scale-[1.02] transition-transform">
      ...
      <footer className="bg-[#0A0A0A] pt-24 pb-12 px-4 border-t border-[#111] relative z-10">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <a 
              href="https://instagram.com/nexus0rigin" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="flex items-center text-gray-400 hover:text-[#FF6B35] transition-colors gap-2"
            >
