        ...
        <div className={`max-w-5xl mx-auto transition-all duration-1000 ${aboutVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-400 max-w-4xl mx-auto mb-12">
              O Nexus resolve um dos maiores desafios da atualidade: <span className="text-[#FF6B35] font-semibold"> acompanhar o ritmo acelerado das tecnologias emergentes</span> e ser seu guia nesse processo.
            </p>
          </div>
