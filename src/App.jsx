...
const Button = ({ children, className, ...props }) => (
    <button
      className={`
        bg-[--color-nexus-cta] hover:bg-[--color-nexus-cta-light] 
        text-white font-bold py-3 px-6 rounded-lg 
        transition-all duration-300 transform hover:scale-[1.02] 
        focus:outline-none focus:ring-4 focus:ring-[--color-nexus-cta]/50
        ${className}
      `}
      {...props}
    >
  ...
  return (
    <>
      <style>{`
        ...
        :root {
          /* PALETA NEXUS REFINADA */
          --color-nexus-bg: #1A2A3A;         /* AZUL METÁLICO ESCURO (Fundo) */
          --color-nexus-teal: #2DD4BF;        /* AZUL TURQUESA (Identidade Principal) */
          --color-nexus-orange: #FF6B35;      /* Laranja (Detalhes/Contraste) */
          --color-nexus-cta: #FF4F1F;         /* Vermelho Alaranjado (BOTÕES DE VENDA) */
          --color-nexus-cta-light: #FF7F50;   /* Variação CTA (para gradientes) */
        }
        ...
        * {
        ...
        .banner-item {
          ...
          font-size: 0.85rem;
          font-weight: 700;
          color: #020408; /* Texto escuro para contraste no banner claro */
        ...
        .horizontal-banner-mid-section .banner-item {
          color: #DBEEFF; /* Tom de azul bem claro */
        }
        
        /* Efeito de hover nos cartões (Borda Turquesa) */
        .nexus-card {
          background-color: #14222E; /* Cor de fundo para o card */
        ...
        .pulse-button:hover {
          background: var(--color-nexus-cta-light); /* Usando light para o hover */
      ...
      {/* O main div usa as variáveis CSS customizadas definidas em App.css */}
      <div className="min-h-screen bg-[--color-nexus-bg] font-['Poppins',sans-serif] overflow-x-hidden text-slate-100 selection:bg-[--color-nexus-teal] selection:text-black">
        ...
        <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
            ...
            {/* Grid Tech - Usando classes Tailwind e fundo mockado com URL de dados */}
          ...
          <div className={`max-w-7xl mx-auto text-center transition-all duration-1000 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="inline-flex items-center relative mb-8 group cursor-default animate-fade-in">
              ...
              <div className="relative px-6 py-2 bg-[#0A0A0A] border border-[--color-nexus-teal]/30 rounded-full flex items-center gap-3">
                  ...
                  <span className="text-sm font-semibold text-[--color-nexus-teal] tracking-wide">
              ...
              <div className="banner-content">
                {[...Array(6)].map((_, i) => (
                  <span key={i} className="banner-item font-mono tracking-widest flex items-center text-lg" style={{color: MID_BANNER_TEXT_COLOR, padding: '0 2rem'}}> 
                    <Sparkles className="w-4 h-4 mr-3 text-[--color-nexus-orange]" /> NEXUS SYSTEM
                  </span>
                ))}
              </div>
            </div>
