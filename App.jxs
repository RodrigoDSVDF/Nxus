...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[--color-nexus-bg] font-['Poppins',sans-serif] overflow-x-hidden text-slate-100 selection:bg-[--color-nexus-cta] selection:text-white">
      ...
      {/* 6. ECOSSISTEMA NEXUS */}
      <section id="ecosystem" ref={ecosystemRef} className="relative z-10 py-32 px-4 bg-gradient-to-b from-[#0A0A0A] to-[#0A0A0A]/90">
        <div className="max-w-7xl mx-auto">
          <div className={`text-center mb-20 transition-all duration-1000 ${ecosystemVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="inline-flex items-center gap-3 mb-6 px-6 py-3 bg-gradient-to-r from-[#22D3EE]/20 to-[#2DD4BF]/20 rounded-full border border-[#22D3EE]/30">
              <Network className="w-5 h-5 text-[#22D3EE]" />
              <span className="text-sm font-semibold text-[#22D3EE] tracking-wide">
                O ECOSSISTEMA COMPLETO
              </span>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold mb-6">
              Mais que Ferramentas, Uma <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#22D3EE] to-[#2DD4BF]">Extensão da Sua Mente</span>
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Não oferecemos apenas um manual. Entregamos um sistema operacional mental completo para sua evolução na era da IA.
            </p>
          </div>
          ...
          <div className="space-y-32">
            {ecosystemFeatures.map((feature, index) => (
              <div
                key={index}
                className={`grid md:grid-cols-2 gap-12 items-center transition-all duration-1000 delay-${index * 200} ${ecosystemVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
              >
                {/* Imagem à esquerda para índices pares, à direita para ímpares */}
                <div className={`relative group ${index % 2 === 1 ? 'md:order-2' : ''}`}>
                  <div className="absolute -inset-4 bg-gradient-to-r from-[#22D3EE]/20 to-[#2DD4BF]/20 rounded-3xl blur-2xl opacity-0 group-hover:opacity-70 transition-opacity duration-700"></div>
                  <div className="relative rounded-3xl overflow-hidden border border-[#333] shadow-2xl group-hover:border-[#22D3EE]/50 transition-all duration-500">
                    <img 
                      src={feature.image} 
                      alt={feature.title}
                ...
                <div className={`space-y-6 ${index % 2 === 1 ? 'md:order-1' : ''}`}>
                  <div className="flex items-center gap-3">
                    <div className="w-3 h-3 rounded-full bg-gradient-to-r from-[#22D3EE] to-[#2DD4BF] animate-pulse"></div>
                    <span className="text-sm font-semibold text-[#22D3EE] uppercase tracking-widest">
                      {feature.tagline}
                    </span>
                  </div>
                  ...
                  <div className="pt-4">
                    <div className="flex items-center gap-2 text-sm text-gray-500">
                      <div className="flex-1 h-px bg-gradient-to-r from-[#22D3EE] to-transparent"></div>
                      <span className="flex-shrink-0 px-4 py-2 bg-[#1A2A3A] rounded-full border border-[#22D3EE]/20">
                        {index + 1} de {ecosystemFeatures.length}
                      </span>
                      <div className="flex-1 h-px bg-gradient-to-l from-[#2DD4BF] to-transparent"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* CTA intermediário */}
          <div className={`mt-20 text-center transition-all duration-1000 delay-1000 ${ecosystemVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            <div className="inline-block mb-8">
              <div className="flex items-center gap-4 px-8 py-4 bg-gradient-to-r from-[#1A2A3A] to-[#0A0A0A] border border-[#22D3EE]/30 rounded-full">
                <Brain className="w-6 h-6 text-[#22D3EE]" />
                <span className="text-lg font-semibold text-white">Sistema Operacional Completo</span>
            ...
            >
              <Button className="group relative overflow-hidden h-14 px-8 text-lg font-bold bg-gradient-to-r from-[#22D3EE] to-[#2DD4BF] hover:from-[#0EA5E9] hover:to-[#0DC7B8] transition-all duration-500">
                <span className="relative z-10 flex items-center gap-3">
                  ACESSAR O ECOSSISTEMA COMPLETO
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-2 transition-transform" />
                </span>
                <div className="absolute inset-0 bg-gradient-to-r from-[#0EA5E9] to-[#0DC7B8] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </Button>
            </a>
          </div>
        </div>
